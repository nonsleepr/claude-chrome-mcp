...
import { title, section, command, dim, insecure, insecureWithBg, success as successColor, code, url, highlightJSON, warning, warningBlock, symbols, labelValue, path as pathColor, secure, } from './utils/format.js';
function parseArgs() {
